...
var hoursOperation = ['6am', '7am', '8am', '9am', '10am', '11am', '12pm', '1pm', '2pm', '3pm', '4pm', '5pm', '6pm', '7pm', 'TOTAL'];
...
CookieStore.prototype.salesPerHour = function() {
  this.cookiesPerHour();
  for(var i = 0; i < this.cookiesPerHourArray.length -1; i++) {
...
//modelled after what was demonstrated in lecture
...
var formVariable = document.getElementById('storeForm');
...
function handleButton(event) {
  ...
  if (!avgCookieSale || !maxCust || !minCust ||!location) {
    return alert('Please fill out all details');
  }
  new CookieStore(location, minCust, maxCust, avgCookieSale);
...
formVariable.addEventListener('submit', handleButton);
